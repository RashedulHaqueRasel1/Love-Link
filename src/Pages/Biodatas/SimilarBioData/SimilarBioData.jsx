...
const SimilarBioData = ({ data }) => {
    ...
    return (
        <div>
            ...
            <div className="w-full max-w-sm overflow-hidden hover:bg-blue-300 bg-blue-200 border-2 border-blue-400 rounded-lg shadow-lg dark:bg-gray-800  mt-1">
                <img src={data.photo || LogoImg} alt="" className="w-full lg:h-[300px] rounded-2xl p-4"/>
